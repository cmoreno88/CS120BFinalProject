...
unsigned char GetKeypadKey() {
	...
	// Check keys in col 1
	KEYPADPORT = 0xEF;	//SetBit(0xFF,COL1,0); // Set Px4 to 0; others 1
	...
	// Check keys in col 2
	KEYPADPORT = 0xDF;	//SetBit(0xFF,COL2,0); // Set Px5 to 0; others 1
	asm("nop"); // add a delay to allow PORTx to stabilize before checking
	...
	// Check keys in col 3
	KEYPADPORT = 0xBF;	//SetBit(0xFF,COL3,0); // Set Px6 to 0; others 1
	asm("nop"); // add a delay to allow PORTx to stabilize before checking
	...
	// Check keys in col 4
	KEYPADPORT = 0x7F;	//SetBit(0xFF,COL4,0); // Set Px7 to 0; others 1
	asm("nop"); // add a delay to allow PORTx to stabilize before checking
